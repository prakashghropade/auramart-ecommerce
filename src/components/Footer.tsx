        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10 gap-14">
          <div>
            ...
            <div className="dark:text-gray-400">
              <p className="mt-6">New York, USA</p>

              <a href="mailto:support@auramart.com" className="block mt-3 hover:text-primary transition-colors">
                support@auramart.com
              </a>
              <a href="tel:+1 800 123 4567" className="block mt-1 hover:text-primary transition-colors">
                +1 800 123 4567
              </a>
        ...
        <div className="container text-center text-sm text-gray-500 dark:text-gray-400">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="inline-block animate-heartbeat">
              <svg
                className="w-5 h-5 text-primary transition-all duration-500 drop-shadow-md"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600 hover:scale-105 transition-transform inline-block"
            >
              AuraMart Team
            </a>
          </div>
